...
public class IngredientControllerTest {
  ...
  private final IngredientEntity ingredient1 =
      new IngredientEntity(1L, "Sugar", false, false, false, false, null);
  private final IngredientEntity ingredient2 =
      new IngredientEntity(2L, "Spice", false, false, false, false, null);
  ...
  public void testSearchIngredientSuccess() throws Exception {
    ...
    mockMvc
        .perform(
            get("/api/ingredient/search").param("query", "tool").accept(MediaType.APPLICATION_JSON))
