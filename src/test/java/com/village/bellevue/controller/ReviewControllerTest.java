...
class ReviewControllerTest {
    ...
    void testReadReviewSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/review/" + review.getId()))
    ...
    void testReadAllByRecipeSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/review/recipe/" + recipe.getId())
                .param("p", "0")
                .param("n", "5"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON));
    ...
    void testUpdateReviewSuccess() throws Exception {
        ...
        mockMvc.perform(put("/api/review/" + review.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(gson.toJson(review)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON));
    ...
    void testDeleteReviewSuccess() throws Exception {
        mockMvc.perform(delete("/api/review/" + review.getId()))
    ...
    void testReadAllByAuthorSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/review/author/" + friend.getId())
                .param("p", "0")
                .param("n", "5"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON));
