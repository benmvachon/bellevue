...
class RecipeControllerTest {
    ...
    void testReadRecipeSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/recipe/" + recipe.getId()))
    ...
    void testReadRatingSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/recipe/" + recipe.getId() + "/rating"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    ...
    void testReadAllRecipesSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/recipe/author/" + currentUser.getId() + "?p=0&n=5"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    ...
    void testSearchRecipesSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/recipe/search?q=test&p=0&n=5"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
