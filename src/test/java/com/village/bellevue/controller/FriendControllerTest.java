...
public class FriendControllerTest {
    ...
    private final FriendEntity friendship = new FriendEntity(currentUser.getId(), friend, FriendshipStatus.ACCEPTED, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()));
    ...
    public void testRequestFriendSuccess() throws Exception {
        mockMvc.perform(post("/api/friend/request/1"))
    ...
    public void testReadFriendSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/friend/1"))
    ...
    public void testReadFriendsSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/friend/friends/1?p=0&n=5"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    ...
    public void testBlockUserSuccess() throws Exception {
        mockMvc.perform(post("/api/friend/block/1"))
                .andExpect(status().isOk())
    ...
    public void testRemoveFriendSuccess() throws Exception {
        mockMvc.perform(delete("/api/friend/remove/1"))
                .andExpect(status().isOk())
