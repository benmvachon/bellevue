...
class CacheConfigTest {
    ...
    void testGetCacheKey() {
        ...
        String expectedKey = cacheKey + CacheConfig.CACHE_KEY_SEPARATOR + userId + CacheConfig.CACHE_KEY_SEPARATOR + entityId;
    ...
    void testGetEntityCacheKeyPattern() {
        ...
        String expectedPattern = cacheKey + CacheConfig.CACHE_KEY_SEPARATOR + CacheConfig.CACHE_WILDCARD_MATCH + CacheConfig.CACHE_KEY_SEPARATOR + entityId;
    ...
    void testGetUserCacheKeyPattern() {
        ...
        String expectedPattern = cacheKey + CacheConfig.CACHE_KEY_SEPARATOR + userId + CacheConfig.CACHE_KEY_SEPARATOR + CacheConfig.CACHE_WILDCARD_MATCH;
