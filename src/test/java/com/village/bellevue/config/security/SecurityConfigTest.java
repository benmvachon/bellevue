...
class SecurityConfigTest {
  ...
  @Mock public AuthenticationSuccessHandlerImpl authenticationSuccessHandler;
  @Mock public LogoutSuccessHandlerImpl logoutSuccessHandler;
  ...
  void testGetAuthenticatedUserId() {
    ...
    try (MockedStatic<SecurityContextHolder> mockContextHolder =
