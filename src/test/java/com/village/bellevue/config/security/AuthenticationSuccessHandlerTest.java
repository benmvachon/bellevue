...
public class AuthenticationSuccessHandlerTest {
    ...
    @Test
    public void testOnAuthenticationSuccess_UserIsAuthenticated() throws IOException, ServletException {
    ...
    @Test
    public void testOnAuthenticationSuccess_AuthenticationIsNull() throws IOException, ServletException {
